...
if showPlot == True:
	...
	fig.suptitle("Graphics for Roll- and Pitch-axis noise")
	axs[0].plot(plotData_roll)
	axs[0].set_title('Roll-axis data')
	axs[1].plot(plotData_pitch, 'tab:green')
	axs[1].set_title('Pitch-axis data')
